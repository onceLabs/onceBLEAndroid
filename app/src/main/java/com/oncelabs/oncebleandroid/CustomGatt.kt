...
val BLUEBIRD_BATTERY_SERVICE_UUID                = UUID.fromString("180F")//UUID.fromString( "180F")
val BLUEBIRD_BATTERY_LEVEL_CHARACTERISTIC_UUID   = UUID.fromString( "2A19")
...
val BLUEBIRD_UUID_SERVICE_ENVIRONMENTAL            = UUID.fromString( "00001000-C356-78AB-3C46-339399E84975")
val BLUEBIRD_UUID_CHARACTERISTIC_TEMPERATURE       = UUID.fromString( "00001001-C356-78AB-3C46-339399E84975")
val BLUEBIRD_UUID_CHARACTERISTIC_HUMIDITY          = UUID.fromString( "00001002-C356-78AB-3C46-339399E84975")
val BLUEBIRD_UUID_CHARACTERISTIC_AMBIENT_LIGHT     = UUID.fromString( "00001003-C356-78AB-3C46-339399E84975")

/*MOTION SERVICE UUIDS*/
val BLUEBIRD_UUID_SERVICE_MOTION                   = UUID.fromString( "00002000-C356-78AB-3C46-339399E84975")
val BLUEBIRD_UUID_CHARACTERISTIC_ACCELERATION      = UUID.fromString( "00002001-C356-78AB-3C46-339399E84975")
val BLUEBIRD_UUID_CHARACTERISTIC_GYROSCOPE         = UUID.fromString( "00002002-C356-78AB-3C46-339399E84975")
val BLUEBIRD_UUID_CHARACTERISTIC_QUATERNION        = UUID.fromString( "00002003-C356-78AB-3C46-339399E84975")
...
val BLUEBIRD_UUID_CHARACTERISTIC_CAP_TOUCH_BUTTON  = UUID.fromString( "00003003-C356-78AB-3C46-339399E84975")
...
val BLUEBIRD_UUID_DEVICE_INFORMATION_SERVICE       = UUID.fromString( "180A")
val BLUEBIRD_UUID_CHARACTERISTIC_FIRMWARE_REVISION = UUID.fromString( "2A26")
...
class CustomGatt: OBGatt() {
    ...
    var bluebirdStreamingAudioCharacgeristic: OBCharacteristic? = null
    ...
    init {
        addServices(
            ...
            OBService(
                ...
                { this.bluebirdEnvironmentalService = it },
                arrayOf(
                    OBCharacteristic(
            ...
            OBService(
                ...
                arrayOf(
                    ...
                    OBCharacteristic(
                        ...
                        { this.bluebirdStreamingAudioCharacgeristic = it },
                        arrayOf())
                )),
